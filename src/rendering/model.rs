// 3D model vertexers need a position, texture coordinates and a normal.
...
impl Vertex for ModelVertex {
    fn desc() -> wgpu::VertexBufferLayout<'static> {
        // this is basically the same as when we did the vertex normally but since we added the normal parameter we add another attribute to the layout
...
pub trait DrawModel<'a> {
    ...
    // these will let me draw all the object
